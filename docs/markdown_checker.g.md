...
```python
def _check_colon_before_code(self, filename: Path, line: str, line_num: int, content_lines: list[str], line_index: int, code_block_info: list) -> Generator[str, None, None]
```
