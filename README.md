...
| 🔧 [`dumps_pretty_json`](https://github.com/Harrix/harrix-pylib/blob/main/docs/funcs_dev.g.md#-function-dumps_pretty_json)                           | Serialize JSON with 2-space indent and short primitive arrays on one line.         |
...
| 🔧 [`is_named_note_folder`](https://github.com/Harrix/harrix-pylib/blob/main/docs/funcs_md.g.md#-function-is_named_note_folder)                                             | Return whether `folder` is a named note folder (`Folder/Folder.md`).                                            |
...
| 🔧 [`sort_list_by_date`](https://github.com/Harrix/harrix-pylib/blob/main/docs/funcs_md.g.md#-function-sort_list_by_date)                                                   | Sort list-entry sections in a Markdown file by watching/reading/event date.                                     |
| 🔧 [`sort_list_by_date_content`](https://github.com/Harrix/harrix-pylib/blob/main/docs/funcs_md.g.md#-function-sort_list_by_date_content)                                   | Sort list-entry `##`/`###` sections by date fields, newest first.                                               |
...
| 🏛️ Class [`DocsSymbolIndex`](https://github.com/Harrix/harrix-pylib/blob/main/docs/funcs_py.g.md#️-class-docssymbolindex)                                                | Maps unambiguous symbol names to documentation heading targets.                             |
| 🏛️ Class [`DocsSymbolTarget (NamedTuple)`](https://github.com/Harrix/harrix-pylib/blob/main/docs/funcs_py.g.md#️-class-docssymboltarget)                                 | Resolved documentation target for an API symbol cross-link.                                 |
...
| Function/Class                                                                                                                                 | Description                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| 🏛️ Class [`ResolvedNoteDate`](https://github.com/Harrix/harrix-pylib/blob/main/docs/note_meta.g.md#️-class-resolvednotedate)                    | Resolved calendar date for a note and where it came from.                           |
