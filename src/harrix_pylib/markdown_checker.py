...
class MarkdownChecker:
    ...
    # Rules enabled only when explicitly selected (``--rule H054`` etc.)
    _OPT_IN_RULES: ClassVar[frozenset[str]] = frozenset({"H046", "H047", "H054", "H055", "H056"})
    ...
    def __init__(self, project_root: Path | str | None = None) -> None:
        ...
        self.all_rules = set(self.RULES.keys()) - self._OPT_IN_RULES
