...
class MdChecker:
    ...
    - **H085** - Non-descriptive link text (`click here`, `сюда`, …; lang-aware). # ignore: HP001
    ...
    def _check_non_code_line_rules(
        ...
        *,
        ...
        if "H062" in rules and lang in {"en", "ru"}:
            yield from self._check_decimal_separators(filename, line, line_num, lang=lang)
