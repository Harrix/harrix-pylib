...
| 🔧 [`extract_zip_archive`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-extract_zip_archive)                             | Extract ZIP archive to the folder where the archive is located and remove the archive file.       |
...
| 🔧 [`list_files_simple`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-list_files_simple)                                 | Generate a simple list of all files in a directory structure.                                     |
...
| 🔧 [`remove_empty_folders`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-remove_empty_folders)                           | Remove all empty folders recursively while respecting ignore patterns.                            |
| 🔧 [`rename_epub_file`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-rename_epub_file)                                   | Rename EPUB file based on metadata from file content.                                             |
| 🔧 [`rename_fb2_file`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-rename_fb2_file)                                     | Rename FB2 file based on metadata from file content.                                              |
| 🔧 [`rename_file_spaces_to_hyphens`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-rename_file_spaces_to_hyphens)         | Rename file by replacing spaces with hyphens in the filename.                                     |
| 🔧 [`rename_files_by_mapping`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-rename_files_by_mapping)                     | Rename files recursively based on a mapping dictionary while respecting ignore patterns.          |
...
| 🔧 [`rename_pdf_file`](https://github.com/Harrix/harrix-pylib/tree/main/docs/funcs_file.g.md#🔧-function-rename_pdf_file)                                     | Rename PDF file based on metadata from file content.                                              |
...
| Function/Class                                                                                                                     | Description                                                            |
| ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| 🏛️ Class [`MarkdownChecker`](https://github.com/Harrix/harrix-pylib/tree/main/docs/markdown_checker.g.md#🏛️-class-markdownchecker) | Class for checking Markdown files for compliance with specified rules. |
...
| Function/Class                                                                                                               | Description                                                          |
| ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| 🏛️ Class [`PythonChecker`](https://github.com/Harrix/harrix-pylib/tree/main/docs/python_checker.g.md#🏛️-class-pythonchecker) | Class for checking Python files for compliance with specified rules. |
