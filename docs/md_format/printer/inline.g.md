...
- [🔧 Function `_inline_children_are_link_run`](#-function-_inline_children_are_link_run)
...
- [🔧 Function `_render_packed_link_run`](#-function-_render_packed_link_run)
...
## 🔧 Function `_inline_children_are_link_run`
...
## 🔧 Function `_inline_neighbor_text`
...
## 🔧 Function `_pack_link_parts`

```python
def _pack_link_parts(parts: list[str]) -> list[str]
```
...
## 🔧 Function `_render_packed_link_run`

```python
def _render_packed_link_run(children: list[Token]) -> str
```
...
## 🔧 Function `_softbreak_follows_trailing_backslash`
...
## 🔧 Function `_softbreak_should_omit_space`
